...
# Consumer Key
ckey = "fpU1bc5Xd60sCt5YRVS3A"
# Consumer Secret
csecret = "N00ukY7yzLCAtYStcUKUxWUlgKRTUcvuBBNirwLhpME"

## follow logic is need's Asahi Develop Environment
##passmgr = urllib2.HTTPPasswordMgrWithDefaultRealm()
##passmgr.add_password(None,"http://1.1.179.155:8080","59807478","1q1q1q1q")
...
# Access Token
atoken = "340682418-bUcTsS73dWF8tRj35wlDEEcu8EoSacnhxfS95lPM"
# Access Token Secret
atoken_secret = "v6ibhTD3wQeF7M6cCxF3IqveCktjzPdUkQfGycnOU"
...
# status update
#post_url = 'http://twitter.com/statuses/update.xml' 2012/10/29
post_url = 'http://api.twitter.com/1/statuses/update.xml'
...
# yamatextから発言を取得
postlist = open("yamabot1.txt","r").read()
